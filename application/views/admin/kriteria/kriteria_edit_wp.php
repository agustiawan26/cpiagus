                                        ...
                                        <div class="card-body">
                                            <form method="post">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control form-control-round" placeholder="Masukan Nama Kriteria" name="kriteria" value="<?php echo $select->kriteria; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="d-block text-center card-footer">
                                                    ...
                                                    <button type="submit" class="btn-wide btn btn-success" name="updatekriteriawp" value="updatekriteriawp">Simpan Data</button>
                                                </div>
