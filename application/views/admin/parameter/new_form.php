    ...
    <?php $this->load->view("admin/_partials/navbar.php") ?>
        ...
        <div class="app-main">
            ...
            <div class="card-header">
                ...
                <a href="<?php echo site_url('admin/parameter/') ?>"><i class="fas fa-arrow-left"></i>
                    Back</a>
                </div>
                                    ...
                                    <div class="card-body">
                                        <form action="<?php echo site_url('admin/kriteria/add') ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="position-relative row form-group"><label for="tren" class="col-sm-2 col-form-label">Tren</label>
                                                <div class="col-sm-10"><input name="tren" id="tren" placeholder="Tren" type="text" class="form-control"></div>
                                                <div class="invalid-feedback">
