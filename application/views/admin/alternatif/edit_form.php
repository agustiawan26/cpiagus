                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane tabs-animation fade show active" id="tab-content-1" role="tabpanel">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        <form action="<?php echo site_url('alternatif/edit');?>" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="id" value="<?php echo $alternatif->alternatif_id?>" />
                                            ...
                                            <div class="position-relative row form-group"><label for="kecamatan" class="col-sm-2 col-form-label">Kecamatan</label>
                                                <div class="col-sm-10"><input name="kecamatan" id="kecamatan" placeholder="Kecamatan" type="text" class="form-control" value="<?php echo $alternatif->kecamatan ?>" ></div>
                                                <div class="invalid-feedback">
