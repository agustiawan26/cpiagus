        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="primary_menu">
                <ul class="nav navbar-nav mainmenu">
                    ...
                    <li><a href="#features_page">Data Kriteria</a></li>
                    <li><a href="#gallery_page">Data Alternatif</a></li>
                    <li><a href="#price_page">Data Nilai</a></li>
                    <li><a href="#questions_page">Peringkat</a></li>
